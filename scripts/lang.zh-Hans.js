...
STRINGS.UPLOAD_FAILED = '上传失败，请重新打开文件传输服务并刷新此页重新上传。';
//STRINGS.UNSUPPORTED_FILE_TYPE = '请选择APK文件。';
STRINGS.UNSUPPORTED_FILE_TYPE = '请选择文件。';
STRINGS.FILE_IN_QUEUE = '文件已经在上传列队中。';
STRINGS.FILE_EXISTS = '文件已存在,未上传。';
STRINGS.FILE_EXISTS_MULTI = '个文件已存在共享目录中,未上传.\n';
...
STRINGS.CANNOT_CONNECT_SERVER = '无法连接WiFi传输服务器，请重新打开文件传输服务并刷新此页后重新上传。';
